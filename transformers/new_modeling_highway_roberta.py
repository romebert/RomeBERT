...
from .new_modeling_highway_bert import BertModel, BertPreTrainedModel, BertEncoder, entropy, HighwayException, KDLoss, TAKDLoss, GroupKDLoss, BidirectionLoss
...
class RobertaForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config, ge=False):
        ...
        self.roberta = RobertaModel(config, ge=ge)
